# agent-infra-micro-edge-connector-test-ipg

## Detailed Description

agent-infra-micro-edge-connector-test-ipg is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
